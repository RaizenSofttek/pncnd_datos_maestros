sap.ui.define([
    ...
    var ENTITY_SET = "PNCND_REL_CONC_TIPO_DOC";
    var NOMBRE     = "Rel. Concepto - Tipo Documento";
    var ST_ID      = "stRelConcTipoDoc";

    var COLS_TEMPLATE = [
        { label: "Cod. Concepto", hint: "Texto - máx. 18 caracteres" },
        { label: "Id. Tipo Op.",  hint: "Texto - máx. 14 caracteres" },
        { label: "Id. Tipo Doc.", hint: "Texto - máx. 2 caracteres"  },
    ...
    var COLS_CARGA = [
        ...
        { field: "id_tipo_doc",  header: "Id. Tipo Doc.", type: "String" },
        { field: "linea_moa",    header: "Linea MOA",     type: "String" }
    ];

    function RelConcTipoDoc(oController) {
        this.c         = oController;
        this._oFile    = null;
    ...
    var p = RelConcTipoDoc.prototype;
    ...
    p.onSearch = function (oEvent) {
        ...
        var aF = sQ ? [new Filter({
            filters: [
                ...
                new Filter("id_tipo_doc",  FilterOperator.Contains, sQ),
    ...
    p.onEliminar = function (oEvent) {
        ...
        var sDesc = "'" + oData.cod_concepto + "' / '" + oData.id_tipo_op +
                    "' / '" + oData.id_tipo_doc + "' / '" + oData.linea_moa + "'";
        var that  = this;
            ...
            oReader.onload = function (e) {
                try {
                    ...
                    aData.forEach(function (oReg, idx) {
                        COLS_CARGA.forEach(function (oCol) {
                            if (!oReg[oCol.field]) {
                                aErrors.push("Fila " + (idx + 3) + ": campo \"" + oCol.header + "\" es requerido");
                            }
                        });
                    });
                    if (aErrors.length) {
    ...
    p._getDlgCM = function () {
        ...
        var sId = this.c.createId("tdoc_dlgCM");
        this._sDlgCMId = sId;
    ...
    p._getDlgCP = function () {
        ...
        var sId = this.c.createId("tdoc_dlgCP");
        this._sDlgCPId = sId;
        return Fragment.load({ id: sId, controller: this.c,
