    ...
    return {
        validar: function (aData, oModel, fnProgress) {
            ...
            return Promise.all([
                ...
                aRes[0].forEach(function (o) { oTipos[o.id_tipo_aprob]      = true; });
                aRes[1].forEach(function (o) { oNiveles[o.nivel]            = true; });
                aRes[2].forEach(function (o) { oMails[o.mail.toLowerCase()] = true; });
