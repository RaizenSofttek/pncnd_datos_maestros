sap.ui.define([
    ...
    var NOMBRE     = "Aprobadores por Oficina de Ventas";
    var ST_ID      = "stOfVentas";
    ...
    var COLS_TEMPLATE = [
        ...
        { label: "Tipo Aprobador", hint: "Texto - máx. 2 caracteres"  },
        { label: "Nivel",          hint: "Número entero"              },
        { label: "Of. de Ventas",  hint: "Texto - máx. 4 caracteres"  },
    ...
    function AprobOfVentas(oController) {
        this.c             = oController;
    ...
    p.onConfirmarEditar = function () {
        var sMail = Fragment.byId(this._sDlgEditarId, "eOVMail").getValue().trim();
        var that  = this;
    ...
    p._getDlgEditar = function () {
        ...
        var sId = this.c.createId("ov_dlgEdit");
    ...
    p._getDlgMM = function () {
        ...
        var sId = this.c.createId("ov_dlgMM");
        this._sDlgMMId = sId;
        return Fragment.load({ id: sId, controller: this.c,
    ...
    p._getDlgCM = function () {
        ...
        var sId = this.c.createId("ov_dlgCM");
        this._sDlgCMId = sId;
        return Fragment.load({ id: sId, controller: this.c,
    ...
    p._getDlgCP = function () {
        ...
        var sId = this.c.createId("ov_dlgCP");
        this._sDlgCPId = sId;
        return Fragment.load({ id: sId, controller: this.c,
