sap.ui.define([
    ...
    return Controller.extend("zpncnd.datos.maestros.pncnddatosmaestros.controller.Main", {
        ...
        _logTablaMaestra: function () {
            ...
            setTimeout(function () {
                if (!bMetadataOK) {
                    console.error("[PNCND] Metadata sin respuesta tras 8s — el destination 'api-cap-portal-nc-nd-masterdata' en PRD posiblemente apunta a una URL incorrecta o inaccesible");
                }
            }, 8000);
